...
class Logger{
  ...
  /**
   * 
   * @param {object} opts - configure options
   * @param {string|integer} opts.facility - facility name or number (as defined in Logger.facilities). default: user
   * @param {string|integer} opts.level - level name or number (as defined in Logger.level). default: notice
